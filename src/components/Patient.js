...
function Patient(props) {
    ...
    const patient= userData.patients.find(
        (user) => user.nom === props.username && user.code === props.password
    );
        ...
        <>
            <div className="grandContainer">
                <div className="navbar">
                    ...
                    <div className="patientName">Mr, {props.username}</div>
                ...
                <div>
                    <div className="salutation"> Votre Historique</div>
                    ...
                    {tesstSyntrom===true ? (
                        <p style={{ color: 'orange', marginLeft: '3vw', fontSize: '1.5vw' }}>Eviter les aliments riches en vitamine K</p>
                    ) : null}
